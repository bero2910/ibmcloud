######################################################################
#this script goes through all instances on a selected Service and exports
#instances type, CPU, RAM, and sumarized disk usage
#In order to use script you need to be logedin into desired account and 
#select desired Power service 


#!/bin/bash
echo "Instance,type,CPU,RAM,Tier1GB,Tier3GB" >> powerout.csv
